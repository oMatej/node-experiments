...
class BaseExperiments {
  ...
  constructor({ cookies, captureSelectors, experiments, experimentSelector, queryParam, requestKey, versions }) {
    ...
    this._captureSelectors = captureSelectors;
  }
  ...
  /**
   * @param {Object} experimentSelectors
   * @param {Object} requestSelectors
   * @returns {Boolean}
   * @protected
   */
  _isMatchExperiment(experimentSelectors, requestSelectors) {
    return Object.entries(experimentSelectors)
      .findIndex(([ key, value ]) => !requestSelectors[key] || requestSelectors[key] !== value) === -1;
  }
